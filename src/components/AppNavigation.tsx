        ...
        <Box className="nav">
          <div className={page==="/medication" ? "over" : "button-nav"}>
            <IconButton onClick={() => handleClick('/medication')}>
              <img width={24} height={24} alt="" src={page==="/medication" ?  homRed : home} />
            </IconButton>
          </div>
          <Typography className={page==="/medication" ? "typography-over" : "typography-nav"}>Medications</Typography>
        </Box>
        <Box className="nav">
          <div className={page==="/therapie" ? "over" : "button-nav"}>
            <IconButton onClick={() => handleClick('/therapie')}>
              <img width={24} height={24} alt="" src={page==="/therapie" ? prescription : prescriptionBlack} />
            </IconButton>
          </div>
          <Typography className={page==="/therapie" ? "typography-over" : "typography-nav"}>Therapies</Typography>
        </Box>
        <Box className="nav">
          <div className={page==="/contact" ? "over" : "button-nav"}>
            <IconButton onClick={() => handleClick('/contact')}>
              <img width={24} height={24} alt="" src={page==="/contact" ? contactRed : contact} />
            </IconButton>
          </div>
          <Typography className={page==="/contact" ? "typography-over" : "typography-nav"}>Contacts</Typography>
        </Box>
      </div>
    </div>
  );
